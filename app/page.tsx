...
export const metadata: Metadata = {
  ...
  description:
    "Shop premium 3D printers (Ender, Creality), filaments (PLA, ABS, PETG), electronics, Arduino, Raspberry Pi & more. Professional 3D printing, laser engraving services in Bangladesh.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Shop premium 3D printers, filaments, electronics. Professional 3D printing & laser engraving services in Bangladesh.",
  ...
  twitter: {
    ...
    title: "Evo-Tech Bangladesh - 3D Printers, Electronics & Tech Services",
    description:
      "Shop premium 3D printers, filaments, electronics. Professional 3D printing & laser engraving services.",
  },
  alternates: {
...
const CarouselFallback = () => <CarouselLoader />;
...
const Home = async () => {
  ...
  if (isDown) {
    const { default: HomeMaintenancePageDynamic } =
      await import("@/components/maintenance/home-maintenance-page");
    return <HomeMaintenancePageDynamic />;
  }
  ...
  return (
    <>
      ...
      <Suspense
        fallback={
          <div className="w-full py-8 text-center text-stone-400">
